...
if __name__ == '__main__':
    ...
    model = fmen2.make_model(args).cuda()########
    ...
    torch.save(rep_state_dict,
               '/home/srteam/lrq/EDSR-PyTorch/experiment/FMEN_x{}/model/test.pt'.format(args.scale[0])
               )##########
