...
##os.system("bash /data/lrq/edge_dection/patch_train.sh %s %s %s" % (name,name2,scale)) #7.
''''''
...
#os.system("bash /data/lrq/edge_dection/other_test.sh %s %s %s %s" % (name,name2,scale,best_num)) #162
