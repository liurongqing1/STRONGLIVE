...
do
   ...
   do
      ...
      mkdir /data/lrq/edge_dection/$name
      mkdir /data/lrq/edge_dection/$name/HR
      mkdir /data/lrq/edge_dection/$name/sharp
      mkdir /data/lrq/edge_dection/$name/sharp_patch
      mkdir /data/lrq/edge_dection/$name/LR_patch
      mkdir /data/lrq/edge_dection/$name/blur
      ...
      #edge dection
      cp  -r  /data/lrq/feature_extract/GT/$name/001.png /data/lrq/edge_dection/$name/HR/001.png
